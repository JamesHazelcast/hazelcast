...
public class IMapMapClearedUCDTest extends IMapUCDTest {
    @Override
    ...
    protected String[] getUserDefinedClassNames() {
        return new String[] {"usercodedeployment.IMapMapClearedListener", "usercodedeployment.ObservableListener"};
    }
}
